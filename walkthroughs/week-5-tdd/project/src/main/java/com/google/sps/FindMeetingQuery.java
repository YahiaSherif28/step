...
public final class FindMeetingQuery {
  ...
  /** 
   * finds continous intervals of false in timeIsOcuppied[]
   * with lengths greater than or equal to durationOfRequest
   * and returns them as a Collection<TimeRange>
   */
  private Collection<TimeRange> findResultOfQuery (boolean[] timeIsOccupied, long durationOfRequest) {
